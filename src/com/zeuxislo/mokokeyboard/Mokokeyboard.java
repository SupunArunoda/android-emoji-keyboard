...
public class Mokokeyboard extends Keyboard {
	
	private Key mEnterKey;
	
	public Mokokeyboard(Context context, int xmlLayoutResId) {
		super(context, xmlLayoutResId);
	}

	public Mokokeyboard(Context context, int layoutTemplateResId, CharSequence characters, int columns, int horizontalPadding) {
